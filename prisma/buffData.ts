const specialDrinks = [
  ...
  },
  {
    ...
    buffDescription:
      'Increase Max Stamina by 4620 and Max Health by 5051 for 2 hours. If you are a werewolf, the rich marrow will also slightly ease your transformation.',
    description:
      'A thick, hearty broth prepared from domestic and exotic bones and an assortment of meats and herbs. Quite fragrant.',
    duration: 120,
    notes: 'Witches Festival',
    quality: 4,
    icon: 'icon-food-packleadersbonebroth.png'
  },
  {
    name: 'Disastrously Bloody Mara',
    buffDescription:
      'Increase Max Magicka by 4620, Max Health by 5051, and Health Recovery by 505 for 2 hours. If you are a vampire, the tainted blood in this drink will also spark a fierce hunger in you. These effects are scaled based on your level.',
    description:
      'It reeks of cold blood, brimstone, wood smoke, and alcohol. Down the hatch!',
    duration: 120,
    notes: 'Witches Festival',
    quality: 4,
    icon: 'icon-food-disastrouslybloodymara.png'
  },
  {
    name: 'Bewitched Sugar Skulls',
    buffDescription:
      'Increase Max Health by 4620, Max Stamina and Magicka by 4250, and Health Recovery by 462 for 2 hours. These effects are scaled based on your level.',
    description:
    ...
    notes: 'Witches Festival',
    quality: 4,
    icon: 'icon-food-bewitchedsugarskulls.png'
  }
]
